    ...
    <section className="relative w-full min-h-[500px] mt-4 lg:mt-6">
      <div className="relative flex flex-col  w-full md:px-2 xs:max-w-[410px] sm:max-w-[700px] md:max-w-[900px] lg:max-w-[1000px] xl:max-w-[1240px] sm:px-2 mx-auto">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full gap-2 md:gap-3 lg:gap-4 md:px-2 px-1 mb-4">
          <div className="bg-white rounded drop-shadow  min-w-[220px] min-h-[300px] order-1 md:col-span-2">
            1
          </div>
          <div className="bg-white rounded drop-shadow  min-w-full min-h-[300px] order-2 md:col-span-2">
            2
          </div>
          <div className="bg-white rounded drop-shadow  min-w-full min-h-[300px] order-4 lg:order-3">
            3
          </div>
          <div className="bg-white rounded drop-shadow  min-w-full min-h-[300px] order-3 lg:order-4 md:col-span-2">
            1
          </div>
